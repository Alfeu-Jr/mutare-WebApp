    ...
    public function listar()
    {
        ...
        if ($searchValue != '') {
            $searchQuery = " (codigo like '%" . $searchValue . "%' or
                                    armazem like '%" . $searchValue . "%' or
                                    provincia like '%" . $searchValue . "%' or
                                    localizacao like '%" . $searchValue . "%' or
        ...
        if ($len > 0) {
            for ($i = 0; $i < $len; $i++) {
                ...
                //             </a>
                //        ";
                // // Botão que permite visualizar os detalhes
                // $action .= "
                //             <button class='btn btn-info btn-sm detalhe-relatorio btn-pr ml-2' data-id=" . $response[$i]["id"] . " >
